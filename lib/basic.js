...
function _showProfile(user) {
	...
	elm.innerHTML = `
<div style="height: 40px; margin-top: 5px; margin-right: 50px;"><b>Profil-Übersicht</b></div>
<span style="display: inline-block; width: 100%; text-align: center;">
<div style="border-radius: 50%; width: 80px; height: 80px; display: inline-block; margin-bottom: 10px; background-color: var(--accent_color_bg); background-size: 80px 80px; background-image: url('${user.avatar}');"></div>
<br>
<u>${!user.title ? "": user.title+" "}${form1(user.name)}</u>
<br><br>
</span>
<span class="selectable">
Level: ${user.level ?? 0}<br>
Rolle: ${form1(user.role ?? "Student")}
</span><br>
Avatar: <input style="" value="${user.avatar}"><br><br>
<button style="font-size: 18px; width: 100%; border-radius: var(--border-radius); font-weight: normal;" onclick="_showProfileSave(this);">Speichern</button>
	`;
